...
const packages = [
  {
    ...
    itinerary: ["Day 1: Arrival & Evening Safari", "Day 2: Morning Safari & Departure"],
    bestTime: "Oct - Mar",
  ...
  },
  {
    ...
    itinerary: ["Day 1: Basics & Evening Safari", "Day 2: Advanced Techniques", "Day 3: Portfolio Review"],
    bestTime: "Nov - Feb",
  ...
  },
  {
    ...
    itinerary: ["Day 1: Nature Walk & Safari", "Day 2: Caves Tour & Wildlife Education"],
    bestTime: "Year Round",
  ...
  },
  {
    ...
    itinerary: ["Day 1: VIP Arrival & Sunset Safari", "Day 2: Private Safari & Spa", "Day 3: Sunrise Safari & Departure"],
    bestTime: "Oct - Mar",
  ...
  },
  {
    ...
    itinerary: ["Day 1-2: Tadoba", "Day 3: Melghat", "Day 4-5: Sanjay Gandhi"],
    bestTime: "Nov - Mar",
  ...
  },
  {
    ...
    itinerary: ["Day 1: Arrival & Team Activities", "Day 2: Safari & Networking"],
    bestTime: "Year Round",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-black text-white overflow-x-hidden">
      ...
      <section className="relative pt-24 pb-16 px-6">
        <div className={`max-w-7xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="mb-8">
            ...
            <p className="text-xl sm:text-2xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
              Discover curated wildlife experiences designed for every adventurer. From weekend getaways to luxury expeditions.
            </p>
          </div>
      ...
      <section className="bg-gradient-to-r from-slate-900/50 to-slate-800/50 py-20 border-t border-slate-700/30">
